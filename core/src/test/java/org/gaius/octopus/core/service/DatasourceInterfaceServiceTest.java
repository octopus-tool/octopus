...
class DatasourceInterfaceServiceTest extends CoreApplicationTests {
    ...
    void test1() throws Exception {
        Map<String, Object> datasourceInfo = Map.of("host", "10.2.2.153", "port", 18103, "user", "root",
                "password", "123456", "database", "cw_doau", "driverClass", "com.mysql.cj.jdbc.Driver",
                "urlFormat",
        ...
        dto.setName("test");
        dto.setContent(Map.of("sql", "select * from cw_doau.aut_script1"));
        Mockito.when(datasourceService.selectById(1)).thenReturn(datasourceDTO);
